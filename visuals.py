...
def visualise_prop_tables(tables: list[pd.DataFrame], titles: list[str], save_charts: bool = True, show_chart: bool= False):
...
def visualise_eval(table: pd.DataFrame, title: str, save_chart: bool = True, show_charts=False):
